...
public class FeatureRequestController {
    ...
    public ControllerResponse<FeatureRequestDTO> createFeatureRequest(
            @Parameter(description = "Feature request details", required = true) @RequestBody FeatureRequestDTO requestDTO,
    ...
    public ControllerResponse<FeatureRequestDTO> getFeatureRequest(
            @Parameter(description = "Feature request ID", required = true) @PathVariable Long id,
            Authentication authentication) {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ControllerResponse<PageResponse<FeatureRequestDTO>> getAllFeatureRequests(
        ...
        PageResponse<FeatureRequestDTO> requests = featureRequestService.getAllFeatureRequests(pageable, userId);
    ...
    public ControllerResponse<PageResponse<FeatureRequestDTO>> getFeatureRequestsByStatus(
        ...
        UUID userId = UUID.fromString(authentication.getName());
        Pageable pageable = PageRequest.of(page, size);
        PageResponse<FeatureRequestDTO> requests = featureRequestService.getFeatureRequestsByStatus(status, pageable,
                userId);
        return ControllerResponse.success("Feature requests retrieved successfully", requests);
    }
    ...
    public ControllerResponse<FeatureRequestDTO> updateFeatureRequestStatus(
            ...
            Authentication authentication) {
        UUID userId = UUID.fromString(authentication.getName());
        FeatureRequestDTO updatedRequest = featureRequestService.updateFeatureRequestStatus(id, newStatus, userId);
