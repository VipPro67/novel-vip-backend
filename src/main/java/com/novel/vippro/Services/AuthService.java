...
import com.novel.vippro.Exception.TokenRefreshException;
...
import com.novel.vippro.Repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    @Transactional
    public ResponseEntity<ControllerResponse<JwtResponse>> refreshAccessToken(String requestRefreshToken) {
        ...
        return refreshTokenRepository.findByToken(requestRefreshToken)
                ...
                .map(refreshToken -> {
                    // Start Rotation: Delete old token, create new one
